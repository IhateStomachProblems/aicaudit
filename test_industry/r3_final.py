...
r = subprocess.run([PYTHON, "-m", "aicaudit", "scan", "aicaudit/", "--output", "json"],
...
print("\nscan.py 复杂度检查:")
src = open(PROJ_DIR + "/aicaudit/scan.py", encoding="utf-8").read()
tree = ast.parse(src)
from aicaudit.rules.performance.complexity import _complexity
